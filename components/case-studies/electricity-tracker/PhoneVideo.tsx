...
export default function PhoneVideo({
  ...
  return (
    ...
    >
      {/* Phone PNG drives the container size */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img
        src="/images/case-studies/electricity-tracker/iphone.png"
        alt=""
        style={{ position: 'relative', width: '100%', display: 'block', zIndex: 2, pointerEvents: 'none' }}
      />

      {/* Video positioned absolutely inside the screen cutout */}
      <div style={{
        position: 'absolute',
        left: '3.5%', right: '3.5%', top: '2.2%', bottom: '2.8%',
        borderRadius: '12%',
        overflow: 'hidden',
        zIndex: 1,
        background: '#060D18',
        ...
        <video
          ...
          muted
          playsInline
          style={{ width: '100%', height: '100%', display: 'block', transform: `scale(${videoScale})`, transformOrigin: 'center center' }}
        >
      ...
      <div className="cs-zoom-hint" style={{ position: 'absolute', bottom: 12, right: 12 }}>
        <ZoomIcon />
        View full size
      </div>
    </div>
